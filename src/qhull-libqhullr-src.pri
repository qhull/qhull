# -------------------------------------------------
# qhull-libqhullr-src.pri -- Qt include project for libqhullr sources and headers
#   libqhullr.pro, libqhullrp.pro, and libqhullrdll.pro are the same for SOURCES and HEADERS
# -------------------------------------------------
